...
from me import check_brainstroke
...
def user_predict():
    ...
    input_predict(username_in_use, gender, age, hypertension, heartdisease, evermarried, worktype, recidencetype , glucoselevel, bmi, smokingstatus)
    answer =check_brainstroke( age,gender,bmi,heartdisease,hypertension,glucoselevel,smokingstatus)
